...
DROP TABLE IF EXISTS `phpshop_modules_ddelivery_system`;
CREATE TABLE IF NOT EXISTS `phpshop_modules_ddelivery_system` (
...
INSERT INTO `phpshop_modules_ddelivery_system` (`id`, `type`, `rezhim`, `declared`, `width`, `height`, `api`, `length`, `weight`, `payment`, `status`, `famile`, `name`, `def_width`, `def_lenght`, `def_height`, `def_weight`) VALUES(1, '0', '0', '100', 'option1', 'option3', '73e402bc645d73e91721ecbc123e121d', 'option2', 'weight', '2', '23', 'famile', 'name', '10', '11', '10', '1');
