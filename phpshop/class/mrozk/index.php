...
<html>
    <head>
        ...
        <script type="text/javascript" src="../example/assets/jquery.the-modal.js"></script>
        <link rel="stylesheet" type="text/css" href="../example/assets/the-modal.css" media="all">
        <link rel="stylesheet" type="text/css" href="../example/assets/demo-modals.css" media="all">
    </head>
    <body>
        ...
        <script>
            ...
            function DDeliveryStart(){
                ...
                DDelivery.delivery('ddelivery', 'http://zirka/modules/mod_ddelivery/framework/mrozk/ajax.php', params, callback);
            }
            <?if(!empty($_GET['fast'])):?>
                DDeliveryStart();
            <?endif;?>
